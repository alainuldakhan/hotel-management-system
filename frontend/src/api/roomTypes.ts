...
export const roomTypesApi = {
  ...
  create: (data: { name: string; description?: string; basePrice: number; maxOccupancy: number; amenities?: string[] }) =>
    client.post<RoomTypeDto>('/room-types', data),
  update: (id: string, data: { name?: string; description?: string; basePrice?: number; maxOccupancy?: number; amenities?: string[] }) =>
